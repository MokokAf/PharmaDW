...
import { getDrugBySlug, getAllDrugs } from "@/lib/drugService";
...
export async function generateMetadata({ params }: Props) {
  ...
  if (!drug) {
    return {
      ...
      description: "Le médicament demandé n'existe pas dans notre base de données.",
    };
  }

  return {
    title: `${drug.name} - DwaIA`,
    description: drug.description.substring(0, 160),
    openGraph: {
      title: drug.name,
      description: drug.description.substring(0, 160),
      type: "article",
